...
??? info "Solutions"
    <iframe src="https://www.youtube.com/embed/1EaAau9x8MI&list=PLYKQVqyrAEj9wDIUyLDGtDAFTKY38BUMN" title="2: Making the Grade(APL Quest 2019-2)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

    [Chat transcript](https://chat.stackexchange.com/transcript/52405?m=63332288#63332288) ∙ [Code on GitHub](https://github.com/abrudz/apl_quest/tree/main/2019/2.apl)
<script>testCases={"a":["14 15 92 65 35 89 79","0,⍳100","¯1+?101⍴⍨?2⍴⍨1+?2"],"b":["2 2⍴61 80 33 100","¯1+?101"],"f":"{'FDCBA'[0 65 70 80 90⍸⍵]}","p":"819⌶"}</script>
