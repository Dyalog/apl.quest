...
??? info "Solutions"
    [![Video on YouTube](/img/2023-3.png)](https://www.youtube.com/watch?v=Rg8OCEMlYGg&list=PLYKQVqyrAEj9wDIUyLDGtDAFTKY38BUMN)
...
<script>testCases={"a":[["4","'HELLO WORLDS'"],["¯4","'HELLO WORLDS'"],["0","'HELLO WORLDS'"],["27","'HELLO WORLDS'"]],"b":[["10000","⎕A[10?26]"],["42","(' ',⎕A)[?⍨27]"],["?26","10↑''"],["10","''"],["¯10","''"],["0","''"]],"f":"{(⍺⌽' ',⎕A)[(' ',⎕A)⍳⍵]}"}</script>
