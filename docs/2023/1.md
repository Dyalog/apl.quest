...
??? info "Solutions"
    [![Video on YouTube](/img/2023-1.png)](https://www.youtube.com/watch?v=LpUOaipgn7s&list=PLYKQVqyrAEj9wDIUyLDGtDAFTKY38BUMN)
    [Chat transcript](https://chat.stackexchange.com/transcript/52405?m=64941297#64941297) ∙ [Code on GitHub](https://github.com/abrudz/apl_quest/tree/main/2023/1.apl)
<script>testCases={"a":["1 2 3 4 5 6 7 8 9","2 1 4 3 6 5 8 7 10 9","1000 2500 1333 1969 3141 2345 3141 4291.9 4291.8 4292","1 3 7 3 5 8 5 8 1 6 1 8 1 10 8 4 3 4 1 4","(?5)+⍳10+?5"],"b":[",1","100⍴?42","⌽(?5)+⍳10+?5"],"f":"{⍵/⍨⍵=⌈\\⍵}"}</script>
