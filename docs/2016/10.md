...
??? info "Solutions"
    [![Video on YouTube](/img/2016-10.png)](https://www.youtube.com/watch?v=5rfCeT_lPk8&list=PLYKQVqyrAEj9wDIUyLDGtDAFTKY38BUMN)
...
<script>testCases={"a":[["5 0 2","2.99 4.99 1.99"],["0 0 0","2.99 4.99 1.99"],["1 2 3 4 5","5 4 3 2 1"],["?5⍴10","?5⍴10"],["0.1×?20⍴100","0.1×?20⍴100"]],"b":[["⍬","⍬"],["?20⍴100","0.1×?20⍴100"],["(-1)+?20⍴?10","0.1×?20⍴100"],["(-10)+?20⍴?20","0.1×?20⍴100"],["(-10)+?20⍴?20","(-10)+?20⍴?20"]],"f":"{+/⍺×⍵}"}</script>
