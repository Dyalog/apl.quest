...
??? info "Solutions"
    [![Video on YouTube](/img/2015-5.png)](https://www.youtube.com/watch?v=9_RPmL2Szkk&list=PLYKQVqyrAEj9wDIUyLDGtDAFTKY38BUMN)
...
<script>testCases={"a":["1 2 3 4 5","5-⍳10","⍳50","?20⍴50","?(10+?20)⍴50"],"b":["10 10⍴⍳100","1","25-?(10+?20)⍴50","5 5⍴⍳25","(2+?3⍴?5)⍴?100⍴50"],"f":"{(({+/(⍵-(≢⍵)⍴(+/⍵)÷≢⍵)*2},⍵)÷≢,⍵)*0.5}"}</script>
