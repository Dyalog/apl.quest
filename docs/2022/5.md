...
description: "Write a function that takes a scalar integer argument and returns a character matrix comprised of spaces and <code>⎕</code> that resembles a left-to-right ascending stairway."
