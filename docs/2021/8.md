...
??? info "Solutions"
    <div onclick="play(this)">
        ![Video on YouTube](../../img/2021-8.png)
        ![Video on YouTube](../../img/yt-big.png)
    </div>

    [Chat transcript](https://chat.stackexchange.com/transcript/52405?m=64533505#64533505)&emsp;∙&emsp;[Code on GitHub](https://github.com/abrudz/apl_quest/tree/main/2021/8.apl)
<script>
