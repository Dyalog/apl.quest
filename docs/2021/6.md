...
??? info "Solutions"
    <div onclick="play(this)">
        ![Video on YouTube](../../img/2021-6.png)
        ![Video on YouTube](../../img/yt-big.png)
    </div>

    [Chat transcript](https://chat.stackexchange.com/transcript/52405?m=64457542#64457542)&emsp;∙&emsp;[Code on GitHub](https://github.com/abrudz/apl_quest/tree/main/2021/6.apl)
<script>
    testCases={"a":["'RNBQKBNR'","'BBNRKNRQ'","'RBBNQNRK'","'BRBKRNQN'","'BRBKRNQN'[?⍨8]"],"b":["''"],"f":"{(≠/(⍸'R'=⍵)<⍵⍳'K')∧(≠/2|⍸'B'=⍵)}","p":","}
    play=e=>e.outerHTML=`<iframe src="https://www.youtube.com/embed/UvlL1OyIJIw" title="6: Fischer Random Chess (APL Quest 2021-6)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
    p_Input.focus()
</script>
